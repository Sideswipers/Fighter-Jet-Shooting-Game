...
namespace Fighter_Jet_Shooting_Game
{
    public partial class Form1 : Form
    {
        ...
        private void gameOver()
        {
            isGameOver = true;
            gameTimer.Stop();
            txtScore.Text += Environment.NewLine + "Imagine Losing!!" + Environment.NewLine + "Press Enter to try again." + Environment.NewLine + "" + Environment.NewLine + "A game made by Mateen A." + Environment.NewLine + "" + Environment.NewLine + "Made Only For A School Project";
